    ...
    return MediaQuery(
      data: MediaQuery.of(context).copyWith(
        textScaler: MediaQuery.of(context).textScaler.clamp(
          maxScaleFactor: 1, // prevents any scaling
        ),
      ),
      child: Scaffold(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        Uri url = Uri.parse('https://www.thegilmannews.com/');
                      ...
                      child: Text(
                        ...
                        style: GoogleFonts.lora(
                          fontSize: 24,
                          color: const Color.fromARGB(255, 13, 13, 213),
                          fontStyle: FontStyle.normal,
                        ),
                      ),
                    ),
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        Uri url = Uri.parse(
                          'https://www.instagram.com/thegilmannews/',
                        );
                        if (await canLaunchUrl(url)) {
                          await launchUrl(url);
                        } else {
